<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Main.master" AutoEventWireup="true" CodeFile="CreateCNDN.aspx.cs" Inherits="Views_CreateCNDN" %>
        ...
        <div class="row">
            ...
            <div class="col-md-12 bar-content" style="height: auto; padding-top: 20px; background: #fbfafa">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">ประเภทSAM CN/DN:</label>
                        <div class="col-md-4">
                                ...
                                <asp:GridView ID="GridViewCNDN_1"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="หน่วย">
                                            <ItemTemplate>
                                                <asp:Label id="Label_PricePerUnit" runat="server" Text='<%# Eval("Unit_of_item") %>' style="color: blue"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="True" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="จำนวน" itemstyle-horizontalalign="right">
                                            <ItemTemplate>
                                                <asp:Label ID="txtOrderingAmount" runat="server" Text='<%# Eval("Amount") %>' style="color: blue"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="True" />
                                        </asp:TemplateField>
