<%@ Page Title="Ordering" Language="C#" MasterPageFile="~/Views/Site.Main.master" AutoEventWireup="true" CodeFile="OrderNew.aspx.cs" Inherits="OrderNew" %>
    ...
    <div class="container-full-content">
        <div class="row">
            <div class="col-md-12 top-bar-content-none" style="height: 45px">
                <span class="title" style="font-size: 18px">สั่งซื้อสินค้า</span>&nbsp;&nbsp;<span class="glyphicon glyphicon-transfer" style="font-size: 18px"></span><!--<img src="Images/help-contents.png" />-->
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <div class="input-group" style="width: 200px">
                            <input type="text" class="form-control" placeholder="DD-MM-YYYY" aria-describedby="basic-addon2" style="border-left: 4px solid #ed1c24; font-size: 13px; color: blue;">
                            <span class="input-group-addon" id="basic-addon2"><a href="#" style="color: #e6400a"><span class="glyphicon glyphicon-calendar"></span></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                                    ...
                                    <div class="tab-pane active" id="tab_default_1">
                                        <table id="productListTable" class="table table-bordred table-striped" style="margin-top: 10px">
                                            ...
                                            <tbody style="overflow: scroll">
                                                ...
                                                <tr>
                                                    <td style="line-height: 35px">72000112
                                                    </td>
                                                    <td style="color: blue; font-size: 15px; line-height: 35px">นมสด 200 CC. จืด
                                                    </td>
                                                    <td style="line-height: 35px">ขวด
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="line-height: 35px">72000121
                                                    </td>
                                                    <td style="color: blue; font-size: 15px; line-height: 35px">นมสด 200 CC. ช็อคโกแลต
                                                    </td>
                                                    <td style="line-height: 35px">ขวด
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="line-height: 35px">72000516
                                                    </td>
                                                    <td style="color: blue; font-size: 15px; line-height: 35px">นมสด 946 CC. 4.3% เฟรชแพค
                                                    </td>
                                                    <td style="line-height: 35px">กล่อง
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="tab-pane" id="tab_default_2">
                                        <table id="productListTable2" class="table table-bordred table-striped" style="margin-top: 10px">
                                            <thead>
                                                ...
                                                <th style="width: 80px; font-weight: 100; border-bottom: 2px solid #f67075; background: #ed1c24; color: #fff; text-align: center">VAT (%)</th>
                                                <th style="width: 150px; font-weight: 100; border-bottom: 2px solid #f67075; background: #ed1c24; color: #fff; text-align: center">จำนวนที่สั่ง</th>
                                            ...
                                            <tbody style="overflow: scroll">
                                                ...
                                                <tr>
                                                    <td colspan="7" style="background: #faaa90; height: 30px; padding-top: 10px; border-left: 4px solid #ed1c24; border-top: 0px; color: #000">XXX CC.
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="line-height: 35px">XXXXXXXX
                                                    </td>
                                                    <td style="color: blue; font-size: 15px; line-height: 35px">XXXXXXXXXXXXXXXX
                                                    </td>
                                                    <td style="line-height: 35px">XXX
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" style="padding-left: 10px; text-align: right; color: blue" value="7.80" disabled="disabled" />
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="line-height: 35px">XXXX
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" style="padding-left: 10px; text-align: right; color: blue" value="31.35" disabled="disabled" />
                                                    </td>
                                    ...
                                    <div class="tab-pane" id="tab_default_3">
                                        <table id="productListTable3" class="table table-bordred table-striped" style="margin-top: 10px">
                                            <thead>
                                                ...
                                                <th style="width: 80px; font-weight: 100; border-bottom: 2px solid #6ac674; background: #186220; color: #fff; text-align: center">VAT (%)</th>
                                                <th style="width: 150px; font-weight: 100; border-bottom: 2px solid #6ac674; background: #186220; color: #fff; text-align: center">จำนวนที่สั่ง</th>
                                            ...
                                            <tbody style="overflow: scroll">
                                                ...
                                                <tr>
                                                    <td colspan="7" style="background: #88ca90; height: 30px; padding-top: 10px; border-left: 4px solid #186220; border-top: 0px; color: #000">XXX CC.
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="line-height: 35px">XXXXXXXX
                        ...
                        <form role="form">
                            <div class="tab-content">
                                <div class="tab-pane active" role="tabpanel" id="step1">
                                    <h3>ขั้นตอนที่ 1</h3>
                                    <p>สั่งซื้อสินค้า : เลือกสินค้า และ จำนวนที่สั่ง ตามต้องการ</p>
