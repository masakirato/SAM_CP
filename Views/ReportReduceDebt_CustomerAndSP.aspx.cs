...
public partial class Views_ReportReduceDebt_CustomerAndSP : System.Web.UI.Page
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            if (IsValidForm())
            {
                ...
                string DebtID = txt_DebtID.Text;
                string DebtName = txt_DebtName.Text;
                ...
                rt_RPT_CUSTOMER_SP = Reports.RPT_SP_DEBT_41221(Region, AgentName, SPName, DebtID, DebtName, DebtDate_From.Text, DebtDate_To.Text, Status, string.Empty, string.Empty);

                if (rt_RPT_CUSTOMER_SP.Count > 0)
                {
                    string User_ID = Request.Cookies["User_ID"].Value;
                    string url = "../Report/ReportViewer_01.aspx?RPT=ReportReduceDebt_CustomerAndSP&Region=" + ddlSearchRegion.SelectedItem.ToString()
