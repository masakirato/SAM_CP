<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Main.master" CodeFile="ReportReduceDebt_CustomerAndAgent.aspx.cs" Inherits="Views_ReportReduceDebt_CustomerAndAgent"  UICulture="th" Culture="th-TH" %>
                ...
                <div class="container-full-content">
                    <div class="row">
                        <div class="col-md-12 top-bar-content-none" style="height: 45px">
                            <span class="title" style="font-size: 18px">รายงานหนี้ลูกค้ากับเอเยนต์</span>
                        </div>
