...
public partial class Views_ReportReduceDebt_CustomerAndAgent : System.Web.UI.Page
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            if (IsValidForm())
            {
                ...
                //rt_RPT_CUSTOMER_DEBT = Reports.RPT_CUSTOMER_DEBT_41223(Region, AgentName, SPName, DebtDate_From.Text, DebtDate_To.Text, Status, string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                if (user_class.User_Group_ID == "CP Meiji")
                {
                    ...
                    {
                        List<RPT_CUSTOMER_DEBT_41223> _inrpt = Reports.RPT_CUSTOMER_DEBT_41223(_cv.Location_Region, _cv.CV_Code, SPName, DebtDate_From.Text, DebtDate_To.Text, Status, string.Empty, string.Empty, string.Empty, string.Empty);
                ...
                if (rt_RPT_CUSTOMER_DEBT.Count > 0)
                {

                    string url = "../Report/ReportViewer_01.aspx?RPT=ReportReduceDebt_CustomerAndAgent&Region=" + Region
                        + "&AgentName=" + AgentName
                        + "&SPName=" + SPName
