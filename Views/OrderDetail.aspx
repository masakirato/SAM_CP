<%@ Page Title="Ordering" Language="C#" MasterPageFile="~/Views/Site.Main.master" AutoEventWireup="true" CodeFile="OrderDetail.aspx.cs" Inherits="OrderDetail" %>
    ...
    <div class="container-full-content">
        <div class="row">
            <div class="col-md-12 top-bar-content-none" style="height: 45px">
                <span class="title" style="font-size: 18px">ตรวจสอบรายการสั่งซื้อสินค้า</span>&nbsp;&nbsp;<span class="glyphicon glyphicon-transfer" style="font-size: 18px"></span><!--<img src="Images/help-contents.png" />-->
            </div>
                                        ...
                                        <table id="productListTable" class="table table-bordred table-striped" style="margin-top: 10px">
                                            ...
                                            <tbody id="product-group1" class="myCollapse">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color: red; line-height: 35px; text-align: right">
                                                        <input type="text" class="form-control" style="padding-left: 10px; text-align: right; color: red" value="200" />
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color: red; line-height: 35px; text-align: right">
                                                        <input type="text" class="form-control" style="padding-left: 10px; text-align: right; color: red" value="50" />
                                                    </td>
                                            ...
                                            <tbody id="product-group2" class="myCollapse">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color: red; line-height: 35px; text-align: right">
                                                        <input type="text" class="form-control" style="padding-left: 10px; text-align: right; color: red" value="400" />
                                                    </td>
                        ...
                        <form role="form">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" role="tabpanel" id="step2">
                                    ...
                                    <ul class="list-inline pull-right">
                                        <li>
                                            <button type="button" class="btn btn-default prev-step" onclick="window.location.replace('OrderNew');">กลับ</button></li>
                                        <li>
                                            <button type="button" class="btn btn-danger next-step" style="width: 120px" onclick="window.location.replace('OrderConfirm');">ต่อไป</button></li>
                                    </ul>
                                </div>
