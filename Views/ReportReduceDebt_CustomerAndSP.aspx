<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site.Main.master"  CodeFile="ReportReduceDebt_CustomerAndSP.aspx.cs" Inherits="Views_ReportReduceDebt_CustomerAndSP" UICulture="th" Culture="th-TH" %>
                ...
                <div class="container-full-content">
                    <div class="row">
                        <div class="col-md-12 top-bar-content-none" style="height: 45px">
                            <span class="title" style="font-size: 18px">รายงานหนี้ลูกค้ากับพนักงาน</span>
                        </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="form-inline">
                                        <label class="col-md-2 control-label">รหัสลูกหนี้ :</label>
                                        <div class="col-md-4">
                                            <asp:TextBox ID="txt_DebtID" runat="server" CssClass="form-control"></asp:TextBox>
                                            
                                        </div>
                                    </div>
                                    <div class="form-inline">
                                        <label class="col-md-2 control-label">ชื่อลูกหนี้ :</label>
                                        <div class="col-md-4">
                                            <asp:TextBox ID="txt_DebtName" runat="server" CssClass="form-control"></asp:TextBox>
