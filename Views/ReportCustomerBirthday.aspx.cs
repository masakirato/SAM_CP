...
public partial class Views_ReportCustomerBirthday : System.Web.UI.Page
{
    ...
    protected void ddlSearchRegion_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlSearchRegion.SelectedValue.ToString() != null)
            {
                ...
                List<dbo_AgentClass> cv_code1 = new List<dbo_AgentClass>();
                ...
                if (ddlSearchRegion.SelectedIndex == 0)
                {
                    ...
                    cv_code1 = new List<dbo_AgentClass>(agent.Where(f => f.DM_ID == User_ID || f.GM_ID == User_ID.Trim() || f.SD_ID == User_ID.Trim() || f.SM_ID == User_ID.Trim() || f.APV_ID == User_ID.Trim()).Select(f => f));
                ...
                {
                    //ddlAgentName
                    agent = dbo_AgentDataClass.Search(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, ddlSearchRegion.SelectedValue.ToString(), "Active", string.Empty);
                    cv_code1 = new List<dbo_AgentClass>(agent.Where(f => f.DM_ID == User_ID || f.GM_ID == User_ID.Trim() || f.SD_ID == User_ID.Trim() || f.SM_ID == User_ID.Trim() || f.APV_ID == User_ID.Trim()).Select(f => f));
